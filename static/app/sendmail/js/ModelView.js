define(function (require) {
	...
	var template = require('text!app/sendmail/tpl/model.html'),
	...
	return Gonrin.ModelView.extend({
		...
		render: function () {
			...
			console.log('laog', currentUser)
			self.$el.find("#from").val(currentUser.email)
			...
			self.$el.find("#btn-send").bind("click", function () {
				...
				var nguoinhan = self.$el.find("#to").val();
				var res = nguoinhan.split(',');
